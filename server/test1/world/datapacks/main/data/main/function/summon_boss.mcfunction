...
tag @e[type=marker,name=console] add crystal1
tag @e[type=marker,name=console] add crystal2
tag @e[type=marker,name=console] add crystal3
tag @e[type=marker,name=console] add crystal4

scoreboard players set @e[type=marker,name=console] dragonHealth 200